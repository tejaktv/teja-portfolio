      ...
      <div className="container mx-auto px-6 py-12 relative">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className={cn(
            ...
            <span className="text-5xl md:text-7xl mt-2 block">Kala Tirumala Venkata Sai Teja</span>
          </h1>
          ...
          <div className={cn(
            ...
            <Link to="/about" className="px-8 py-3 bg-primary text-white rounded-lg shadow-lg hover:shadow-xl hover:translate-y-[-2px] transition-all duration-300">
              About Me
            </Link>
